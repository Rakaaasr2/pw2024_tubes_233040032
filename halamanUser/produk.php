...
<body>
    ...
    <div class="search">
        <div class="container">
            <form>
                <input type="text" name="search" placeholder="Cari obat, vitamin, produk kesehatan lainnya"
                    value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                <input type="hidden" name="kat"
                    value="<?php echo isset($_GET['kat']) ? htmlspecialchars($_GET['kat'], ENT_QUOTES, 'UTF-8') : ''; ?>">
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            if ((isset($_GET['search']) && $_GET['search'] != '') || (isset($_GET['kat']) && $_GET['kat'] != '')) {
                ...
                $where = "AND produk_name LIKE '%" . mysqli_real_escape_string($conn, $search) . "%' AND category_id LIKE '%" . mysqli_real_escape_string($conn, $kat) . "%' ";
            }
...
<div class="footer">
    <div class="container">
        ...
        <small>Copyright &copy; 2024 - AloRakdok</small>
    </div>
</div>
